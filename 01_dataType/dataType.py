# print("Hello, Tejas! Welcome in python space")
...
for i in range(100, 200):
    if (i % 7 ==0) and (i % 5 != 0):
        numbers.append(i)       
# append is use to add the number or value at the in variable(number) and top add into it convert integer into string format
